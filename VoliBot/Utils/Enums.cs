...
namespace VoliBot.Utils
{
    class Enums
    {
        public static object[] champions = new object[] { 
            "AATROX", "AHRI", "AKALI", "ALISTAR", "AMUMU", "ANIVIA", "ANNIE", "ASHE", "AZIR", "BLITZCRANK", "BARD", "BRAND", "BRAUM", "CAITLYN", "CASSIOPEIA", "CHOGATH", "CORKI",
            "DARIUS", "DIANA", "MUNDO", "DRAVEN", "EKKO", "ELISE", "EVELYNN", "EZREAL", "FIDDLESTICKS", "FIORA", "FIZZ", "GALIO", "GANGPLANK", "GAREN", "GNAR", "GRAGAS", "GRAVES",
        ...
        public static object[] regions = new object[] {
            "NA", "EUW", "EUNE", "OCE", "LAN", "LAS", "BR", "TR", "RU", "KR"
        };
        public static object[] spells = new object[] {
            "BARRIER", "CLAIRVOYANCE", "CLARITY", "CLEANSE", "EXHAUST", "FLASH", "GARRISON", "GHOST", "HEAL", "IGNITE", "SMITE", "TELEPORT"
        };
